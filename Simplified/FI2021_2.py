...
from FI2021check import forward
# DISPERSION
...
# layerRefineSet,newWeightMatrix,newVs = CheckPoint(len(np.arange(waveLength0,wavelengthMax,deltaWaveLength)), Vph, Lambda)
layerRefineSet,newWeightMatrix,newVs = CheckPoint(len(Lambda), Vph, Lambda)
print(newWeightMatrix)
regetWeight,invertWeight = SVD(newWeightMatrix)
print(np.matmul(invertWeight,Vph))
