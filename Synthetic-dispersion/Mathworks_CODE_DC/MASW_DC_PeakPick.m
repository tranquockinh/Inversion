...
% using the Phase-Shift method by Park et al., 1998a. Three dispersion curve 
% picking options are available: 1) 'manual', 2) 'auto', or 3) 'none'. If
% the Dispersion Image is picked using 'manual' or 'auto', then the
% valriable named "DispersionCurve" will be a two column vector of frequency
% and phase velocity. The dispersion image is the variable named "AsSum". 
% 
% Links to resources:
...
%
% This example uses synthetic wavefrom data created using DISECA MATLAB script
% http://www.sciencedirect.com/science/article/pii/S0266352X11000425
%
% John Schuh 06 April 2018
...
U=suma_sg; % my x-t domain signals defined for this script
...
freqlimits=[15 80]; % For plotting purposes only. Sets the frequency (Hz)
...
elseif strcmp('manual',pick) == 1 % if manual picking is set
    ...
    title({'Dispersion curve: hand picking'})
